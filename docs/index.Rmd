...
- Controla muitas das configurações do documento no yaml.
<center>
...
- É possível hospedar o seu arquivo de apresentação em sites como o [Github](https://github.com/) e [Netlify](https://www.netlify.com/).
---
# Referências
